    ...
    def __init__(self, root):
        ...
        def draw(event):
            ...
            if is_drawing:
                ...
                self.canvas.create_line(prev_x, prev_y, current_x, current_y, fill=drawing_color, width=line_width, capstyle=tk.ROUND, smooth=True)
        ...
        self.root = root
        self.root.title("ME Paint (it's like ms paint but not terrible)")
        ...
        self.canvas.bind("<Control-MouseWheel>", change_line_width_scroll)
